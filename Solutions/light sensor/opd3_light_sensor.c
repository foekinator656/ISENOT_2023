...
#include "mstimer.h"
#include "ping.h"
const int measurementAttempts = 500;
const int pinNum = 5;
...
// zie https://learn.parallax.com/tutorials/language/propeller-c/propeller-c-simple-circuits/sense-light#:~:text=pin%20to%20decay-,past%20the%201.65%20V,-logic%20threshold.%C2%A0